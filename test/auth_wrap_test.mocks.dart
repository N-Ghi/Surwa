...
// in surwa/test/auth_wrap_test.dart.
...
import 'package:surwa/data/notifiers/profile_completion_notifier.dart' as _i7;
...
/// A class which mocks [ProfileCompletionNotifier].
///
/// See the documentation for Mockito's code generation for more information.
class MockProfileCompletionNotifier extends _i1.Mock
    implements _i7.ProfileCompletionNotifier {
  MockProfileCompletionNotifier() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  bool get hasCheckedProfile =>
      (super.noSuchMethod(
            Invocation.getter(#hasCheckedProfile),
            returnValue: false,
          )
          as bool);
  ...
  @override
  _i5.Future<void> checkProfileCompletion({Function? onUserNotFound}) =>
      (super.noSuchMethod(
            Invocation.method(#checkProfileCompletion, [], {
  ...
  @override
  void setProfileCompletion(bool? isComplete) => super.noSuchMethod(
    Invocation.method(#setProfileCompletion, [isComplete]),
    returnValueForMissingStub: null,
  );

  @override
  _i5.Future<void> clearSavedStatus() =>
      (super.noSuchMethod(
            Invocation.method(#clearSavedStatus, []),
            returnValue: _i5.Future<void>.value(),
            returnValueForMissingStub: _i5.Future<void>.value(),
          )
          as _i5.Future<void>);
